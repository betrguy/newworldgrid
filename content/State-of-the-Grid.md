...
<div class="sotg-dashboard">
  <div class="sotg-panels">
    <div class="sotg-snapshot">
      <div class="sotg-kg-value">0.31 <span class="sotg-kg-unit">KGU</span></div>
      <div class="sotg-kg-delta">▼ -1.46</div>
      <div class="sotg-kg-label">GRID INDEX</div>
    </div>
    <div class="sotg-sparkline"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 108" style="width:100%;max-width:560px;display:block;font-family:monospace"><line x1="10" y1="76" x2="550" y2="76" stroke="#333"/><polyline points="10.0,62.2 118.0,14.0 226.0,57.1 334.0,44.1 442.0,46.9 550.0,76.0" fill="none" stroke="#ffb703" stroke-width="2.5"/><circle cx="550.0" cy="76.0" r="4.5" fill="#ffb703"/><text x="540.0" y="68.0" fill="#ff3333" font-size="11" text-anchor="end">-1.46 KGU</text></svg></div>
  </div>
</div>
| Signal | Value |
|---|---|
