---
title: Sovereign Leverage
layout: page
description: "Power Per Individual — tracking the expanding gap between institutional control and individual capability through space weather, solar phase, and open-source velocity."
---

<!-- LEVERAGE_ENGINE_CONTENT -->
<div class="energy-pulse">
The gap between what institutions control and what individuals can deploy widens quietly. Today&rsquo;s Leverage Index: <strong>4.31 LI</strong> &mdash; unsettled geomagnetic field, winter solar phase (11.5h days, growing), 50 open-source signals tracked in the last 24 hours.
</div>
...
| **Geomagnetic (Kp)** | ███░░░░░░ 3.3 | Unsettled |
| **24h Kp avg / max** | 2.05 / 3.3 | Geo component: 0.65 |
| **Solar Phase** | 11.5h day | Winter, ↑ Lengthening, 78d to solstice |
...
Current 24h window: avg **2.05**, peak **3.3** &mdash; **Unsettled**.

## Solar Phase

Day length today: **11.5 hours** (Winter, ↑ lengthening). 78 days to the next solstice. The solar cycle sets the biological clock of every organism on the planet &mdash; a free, universal timing signal available to anyone paying attention. Day 68 of 365.
